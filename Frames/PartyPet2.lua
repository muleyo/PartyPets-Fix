...
function PFP_PartyPet2:OnEnable()
    function PFP:CreatePartyPet2()
        ...
        -- Register Events
        PFP_P2:RegisterEvent("UNIT_PET")
        PFP_P2:RegisterEvent("UNIT_HEALTH")
        PFP_P2:RegisterEvent("UNIT_MAXHEALTH", PFP_P2:SetMinMaxValues(0, UnitHealthMax("partypet2")))
        PFP_P2:RegisterEvent("PLAYER_ENTERING_WORLD")
        PFP_P2:RegisterEvent("PLAYER_LEAVING_WORLD")
        PFP_P2:RegisterEvent("UNIT_CONNECTION")
        PFP_P2:RegisterEvent("GROUP_ROSTER_UPDATE")
    end
end