...
function PFP_PartyPet3:OnEnable()
    function PFP:CreatePartyPet3()
        ...
        -- Register Events
        PFP_P3:RegisterEvent("UNIT_PET")
        PFP_P3:RegisterEvent("UNIT_HEALTH")
        PFP_P3:RegisterEvent("UNIT_MAXHEALTH", PFP_P3:SetMinMaxValues(0, UnitHealthMax("partypet3")))
        PFP_P3:RegisterEvent("PLAYER_ENTERING_WORLD")
        PFP_P3:RegisterEvent("PLAYER_LEAVING_WORLD")
        PFP_P3:RegisterEvent("UNIT_CONNECTION")
        PFP_P3:RegisterEvent("GROUP_ROSTER_UPDATE")
    end
end