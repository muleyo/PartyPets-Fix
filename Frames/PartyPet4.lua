...
function PFP_PartyPet4:OnEnable()
    function PFP:CreatePartyPet4()
        ...
        -- Register Events
        PFP_P4:RegisterEvent("UNIT_PET")
        PFP_P4:RegisterEvent("UNIT_HEALTH")
        PFP_P4:RegisterEvent("UNIT_MAXHEALTH", PFP_P4:SetMinMaxValues(0, UnitHealthMax("partypet4")))
        PFP_P4:RegisterEvent("PLAYER_ENTERING_WORLD")
        PFP_P4:RegisterEvent("PLAYER_LEAVING_WORLD")
        PFP_P4:RegisterEvent("UNIT_CONNECTION")
        PFP_P4:RegisterEvent("GROUP_ROSTER_UPDATE")
    end
end