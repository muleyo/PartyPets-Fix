...
function PFP_PetPet:OnEnable()
    function PFP:CreatePlayerPet()
        ...
        PFP_Pet:SetPoint("LEFT", CompactPartyFrame, "LEFT", 1, -50)
        ...
        -- Register Events
        PFP_Pet:RegisterEvent("UNIT_PET")
        PFP_Pet:RegisterEvent("UNIT_HEALTH")
        PFP_Pet:RegisterEvent("UNIT_MAXHEALTH", PFP_Pet:SetMinMaxValues(0, UnitHealthMax("pet")))
        PFP_Pet:RegisterEvent("PLAYER_LOGIN")
        PFP_Pet:RegisterEvent("PLAYER_ENTERING_WORLD")
        PFP_Pet:RegisterEvent("GROUP_ROSTER_UPDATE")
    end
end